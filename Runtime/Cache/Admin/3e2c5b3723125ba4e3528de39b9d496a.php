			...
			<div class="row">
				<div class="col-xs-12 center" style="text-align: center;">					
					<ul class="quick-actions">
						<li><a href="#"><i class="icon-cal"></i>已运行：<?php echo (getDay($system["create_time"])); ?>天</a></li>
							...
							<div class="row">
								<div class="col-xs-12 col-sm-4">
									<ul class="site-stats">
										...
										<li><div class="cc"><i class="fa fa-comment"></i> <strong>1</strong> <small>条评论</small></div></li>
										<li><div class="cc"><i class="fa fa-comments"></i> <strong>1</strong> <small>条留言</small></div></li>
								...
								<div class="col-xs-12 col-sm-4">
									<ul class="site-stats">
										...
										<li class="divider"></li>
										<li><div class="cc">程序官网：<a href="http://www.loveteemo.com" target="_blank">&nbsp;&nbsp;http://www.loveteemo.com</a></div></li>
										<li><div class="cc">程序作者：隆航 [ admin@loveteemo.com ]</div></li>
									</ul>
								</div>
								<div class="col-xs-12 col-sm-4">
									<ul class="site-stats">
								...
								<?php if(is_array($s_content)): $i = 0; $__LIST__ = $s_content;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(!empty($vo["ac_id"])): ?><li>
				        				...
				        				<div class="article-post">
					        				<span class="user-info"> By: <?php echo ($vo["ac_name"]); ?> on <?php echo (getTime($vo["ac_time"])); ?>, IP：<?php echo ($vo["ac_ip"]); ?> 在文章中评论</span>
					          				<p>&nbsp;&nbsp;<?php echo (reFace($vo["ac_content"])); ?></p>
					          				<?php if(!empty($vo["ac_rtime"])): ?><a class="btn btn-primary btn-xs">已回复</a>
					          				<?php else: ?>
					        		...
					        		<?php if(!empty($vo["alc_id"])): ?><li>
				        				...
				        				<div class="article-post">
					        				<span class="user-info"> By: <?php echo ($vo["alc_name"]); ?> on <?php echo (getTime($vo["alc_time"])); ?>, IP：<?php echo ($vo["alc_ip"]); ?> 在相册中评论</span>
					          				<p>&nbsp;&nbsp;<?php echo (reFace($vo["aLc_content"])); ?></p>
					          				<?php if(!empty($vo["alc_rtime"])): ?><a class="btn btn-primary btn-xs">已回复</a>
					          				<?php else: ?>
					        		...
					        		<?php if(!empty($vo["sc_id"])): ?><li>
				        				...
				        				<div class="article-post">
					        				<span class="user-info"> By: <?php echo ($vo["sc_name"]); ?> on <?php echo (getTime($vo["sc_time"])); ?>, IP：<?php echo ($vo["sc_ip"]); ?> 在说说中评论</span>
					          				<p>&nbsp;&nbsp;<?php echo (reFace($vo["sc_content"])); ?></p>
					          				<?php if(!empty($vo["sc_rtime"])): ?><a class="btn btn-primary btn-xs">已回复</a>
					          				<?php else: ?>
							...
							<ul class="recent-comments">
								<?php if(is_array($gusts)): $i = 0; $__LIST__ = $gusts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
										<div class="user-thumb">
											<img width="40" height="40" src="<?php echo ($vo["g_img"]); ?>">
										</div>
										<div class="comments">
											<span class="user-info"> User: <?php echo ($vo["g_name"]); ?> on <?php echo (getTime($vo["g_time"])); ?>, IP: <?php echo ($vo["g_ip"]); ?> </span>
											<p>&nbsp;&nbsp;<?php echo (reFace($vo["g_content"])); ?></p>
											<?php if(!empty($vo["g_rtime"])): ?><a class="btn btn-primary btn-xs">已回复</a>
				          					<?php else: ?>
				          						<a href="<?php echo U('Admin/Gust/gustEdit',array('id'=>$vo['g_id']));?>" class="btn btn-primary btn-xs">回复</a><?php endif; ?>
