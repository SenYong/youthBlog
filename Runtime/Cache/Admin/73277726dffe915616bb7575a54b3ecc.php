	...
	<div id="wrapper">
			...
			<div id="user-nav">
	            <ul class="btn-group">
	                ...
	                <li class="btn"><a title="" href=""><i class="fa fa-cog"></i> <span class="text">系统设置</span></a></li>
	                <li class="btn"><a title="" href=""><i class="fa fa-share"></i> <span class="text">退出</span></a></li>
	            </ul>
	        </div>
			...
			<div id="sidebar">
				...
				<ul>
					...
					<li><a href="" target="_blank"><i class="fa fa-home"></i> <span>前端首页</span></a></li>
					<li class="submenu">
						<a href="#"><i class="fa fa-flask"></i> <span>发布内容</span> <i class="arrow fa fa-chevron-right"></i></a>
						<ul>
							<li><a href="<?php echo U('Admin/Say/index');?>">发布说说</a></li>
							<li><a href="">发布文章</a></li>
							<li><a href="">发布新版本</a></li>
						</ul>
					</li>
					<li class="submenu">
					...
					<?php if(($_SESSION['class']) == "1"): ?><li class="submenu">
...
<div id="content">
	<div id="content-header">
		<h1>说说列表</h1>
		<div class="btn-group">
			<a href="" class="btn btn-large" title="发表说说"><i class="fa fa-file"></i></a>
		...
		<div class="col-xs-12">
			<div class="widget-box">
				<div class="widget-title">
					...
					<h5>说说列表</h5>
					<span class="label label-info">1 条 </span>
				</div>
					...
					<table class="table table-bordered table-striped table-hover with-check">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a class="btn btn-success btn-sm" href="">编辑</a>&nbsp;&nbsp;
	...
	$(".delsay",this).click(function(){
		...
		$.ajax({
			...
			success:function(data){
				if(data.error==0){
					succ("完成!",data.msg,"/Admin/Say/saylist");
				}else{
					err("错误!",data.msg);
