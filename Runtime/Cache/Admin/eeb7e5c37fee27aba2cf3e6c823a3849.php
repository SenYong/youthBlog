...
<div id="content">
	<div id="content-header">
		<h1>相册评论回复</h1>
		<div class="btn-group">
			<a href="<?php echo U('Admin/Album/albumContentList');?>" class="btn btn-large" title="相册评论列表"><i class="fa fa-tasks"></i></a>
		</div>
	</div>
	<div id="breadcrumb">
		<a href="index.html" title="回到首页" class="tip-bottom"><i class="fa fa-home"></i> 首页</a>
		<a href="#">互动管理</a>
		<a href="#" class="current">相册评论回复</a>
	</div>
				...
				<div class="widget-content nopadding">
					<form  class="form-horizontal">							
						<div class="form-group">
                            <label class="col-sm-3 col-md-3 col-lg-1 control-label">相册名称</label>
                            <div class=" col-sm-9 col-md-9 col-lg-10">
                            	<div class="input-group input-group-sm">
									<span class="input-group-addon"><i class="fa fa-laptop"></i></span>
                                	<input type="text" value="<?php echo ($info["al_name"]); ?>" class="form-control input-sm" id="al_name" readonly/>
                                	<input type="hidden" value="<?php echo ($info["alc_id"]); ?>" id="alc_id"/>
                                	<input type="hidden"  value="<?php echo ($info["al_id"]); ?>" id="al_id" />
                                </div>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class=" col-sm-9 col-md-9 col-lg-10">
                            	<div class="input-group input-group-sm">
                                	...
                                	<input type="text" value="<?php echo ($info["alc_name"]); ?>" class="form-control input-sm" id="alc_name" />
                                </div>
                            </div>
                        </div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9 col-md-9 col-lg-10">
								<div style="border: 1px solid red;min-height:100px;padding: 5px;"><?php echo (reFace($info["alc_content"])); ?></div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9 col-md-9 col-lg-10">
								<textarea rows="5" class="form-control" id="alc_content"><?php echo ($info["alc_content"]); ?></textarea>
							</div>
						</div>
						...
						<div class="form-group">
                            ...
                            <div class=" col-sm-9 col-md-9 col-lg-10">
                            	<div class="input-group input-group-sm">
                                	...
                                	<input type="text" value="<?php echo (date("Y-m-d H:i:s",$info["alc_time"])); ?>" class="form-control input-sm" id="alc_time" readonly=""/>
                                </div>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class=" col-sm-9 col-md-9 col-lg-5">
                            	<div class="input-group input-group-sm">
                                	...
                                	<input type="text" value="<?php echo ($info["alc_ip"]); ?>" class="form-control input-sm" id="alc_ip" readonly=""/>
                                </div>
                            </div>
                            <div class=" col-sm-9 col-md-9 col-lg-5">
                            	<div class="input-group input-group-sm">
									<span class="input-group-addon"><i class="fa fa-globe"></i></span>
                                	<input type="text" value="<?php echo (getIp($info["alc_ip"])); ?>" class="form-control input-sm" readonly=""/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class=" col-sm-9 col-md-9 col-lg-10">
                            	<div class="input-group input-group-sm">
                                	...
                                	<input type="text" value="<?php echo ($info["alc_email"]); ?>" class="form-control input-sm" id="alc_email"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class=" col-sm-9 col-md-9 col-lg-10">
                            	<div class="input-group input-group-sm">
									<span class="input-group-addon"><i class="fa fa-user"></i></span>
                                	<input type="text" value="<?php echo (session('uname')); ?>" class="form-control input-sm" id="alc_rname" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-9 col-md-9 col-lg-10">
								...
								<textarea rows="5" class="form-control" id="content-text"><?php echo ($info["alc_rcontent"]); ?></textarea>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-actions">
							<button type="button" class="btn btn-success btn-sm btn-add-albumContent">确认回复</button>&nbsp;&nbsp;  
...
<script>
	...
	$('select').select2();
    $('.spinner').spinner();
    $('.btn-add-albumContent').click(function(){
    	var al_id = $("#al_id").val();
    	var al_name = $("#al_name").val();
    	var alc_id = $("#alc_id").val();
    	var alc_name = $("#alc_name").val();
		var alc_email = $("#alc_email").val();
		var alc_content = $("#alc_content").val();
		var alc_rname = $("#alc_rname").val();
		var alc_rcontent = $("#content-text").val();		
		...
		if(!alc_name){
			...
			err("请勿删除回复人!");
			return false;
		}else if(!alc_rcontent){
			err("回复内容不能为空!");
			return false;
		}
		$(".btn-add-albumContent").attr("disabled",true);
		$.ajax({
			type:"post",
			url:"/Admin/Album/albumContentEditH",
			async:true,
			data:{"al_id":al_id,"al_name":al_name,"alc_id":alc_id,"alc_name":alc_name,"alc_email":alc_email,"alc_content":alc_content,"alc_rname":alc_rname,"alc_rcontent":alc_rcontent,"send":send},
			success:function(data){
				if(data.error==0){
					succ("回复相册评论完成!",data.msg,"/Admin/Album/albumContentList");
				}else{
					err(data.msg);
					$(".btn-add-albumContent").removeAttr('disabled');
				}
			},
