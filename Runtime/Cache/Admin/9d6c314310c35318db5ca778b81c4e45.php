			...
			<div class="col-xs-12">
				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><form action="#" method="post" class="form-horizontal" enctype="multipart/form-data" />
								<input name="id" type="hidden" value="<?php echo ($vo["pp_id"]); ?>" class="id" />
								<div class="form-group">
									...
									<div class="col-sm-9 col-md-9 col-lg-10">
										<div style="border: 1px solid #999999;min-height: 100px;text-align: center;padding: 2px;">
											<img src="<?php echo ($vo["pp_img"]); ?>" />
										</div>
									</div>
								</div>
								    
	                            <div class="form-actions">
	                                <a href="<?php echo U('/Admin/System/pptEdit',array('id'=>$vo['pp_id']));?>" class="btn btn-success btn-sm">编辑</a>
