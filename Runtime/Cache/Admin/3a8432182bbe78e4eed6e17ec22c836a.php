			...
			<div class="col-xs-12">
				<div class="widget-box">
					<div class="widget-title">
						...
						<?php else: ?>
						    <h5>修改相册</h5>
						    <input type="hidden" value="<?php echo ($info['al_id']); ?>" id="alid"><?php endif; ?>	
					</div>
					<div class="widget-content nopadding">
						<form method="get" class="form-horizontal">
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-9 col-md-9 col-lg-10">
									<label><input type="radio" name="show" value="1" <?php if(($info['al_show']) == "1"): ?>checked<?php endif; ?> /> Yes</label>
									<label><input type="radio" name="show" value="0" <?php if(($info['al_show']) == ""): ?>checked<?php endif; ?> /> No</label>
								</div>
							</div>
							...
							<div class="form-actions">
								...
								<?php else: ?>
								   <button type="button" class="btn btn-success btn-sm" id="editAl">修改数据库</button><?php endif; ?> 
...
$(document).ready(function(){
	  ...
	  $('#addAl').click(function(){
	  	 ...
	  	 $.ajax({
	  	 	...
	  	 	type: "post",
	  	 	async: true,
	  	 	data: {"al_name":name, "al_img":img, "al_remark":remark, "al_time":time, "al_hit":hit, "al_from":from, "al_ip":ip, "al_root":root, "al_show":show},
	  	 	success: function(data){
	  	 		if(data.error == 0){
	  	 			succ("成功",data.msg,"/Admin/Album/albumList");
	  	 		}else{
	  	 			err(data.msg);
      ...
      $('#editAl').click(function(){
	  	 ...
	  	 $.ajax({
	  	 	...
	  	 	type: "post",
	  	 	async: true,
	  	 	data: {"al_id":alid ,"al_name":name, "al_img":img, "al_remark":remark, "al_time":time, "al_hit":hit, "al_from":from, "al_ip":ip, "al_root":root, "al_show":show},
	  	 	success: function(data){
	  	 		if(data.error == 0){
	  	 			succ("修改成功",data.msg,"/Admin/Album/albumList");
	  	 		}else{
	  	 			err(data.msg);
