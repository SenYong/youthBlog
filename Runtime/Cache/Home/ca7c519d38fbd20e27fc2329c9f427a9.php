    ...
    <div class="row aerousel">
		...
		<h5>
            ...
            <div class="article-copy hidden-xs">
            	<?php if(($info['a_original']) == "1"): ?><p>本文系<?php echo ($info["a_author"]); ?>创作，可自由转载、引用，但需署名作者且注明文章出处..</p>
                    <p>本文标题：<?php echo ($info["a_title"]); ?></p>
                    <p>原文网址：<a>功能暂未开放</a>.</p>
                    <p>本文标签：<a><?php echo ($info["a_keyword"]); ?></a></p>
                    发表自：&nbsp;<?php echo ($info["a_from"]); ?>&nbsp;&nbsp;位于：<?php echo (getIp($info["a_ip"])); ?>&nbsp;&nbsp;评论：&nbsp;<?php echo (count($common)); ?>&nbsp;&nbsp;关键词：&nbsp;<?php echo ($info['a_keyword']?$info['a_keyword']:'暂无标签'); ?>&nbsp;&nbsp;  
                <?php else: ?>
                    <p>非特殊说明，本文版权归<?php echo ($info["a_author"]); ?>所有，转载请注明出处.</p>
                    <p>本文标题：<?php echo ($info["a_title"]); ?></p>
                    <p>本文网址：<a><?php echo (C("SITE_URL")); ?>article-<?php echo ($info["a_id"]); ?>.html</a>.</p>
                    <p>本文标签：<a><?php echo ($info["a_keyword"]); ?></a></p><?php endif; ?>  
            </div>
            <hr />
            ...
            <hr />  
            <?php if(is_array($artcommon)): $i = 0; $__LIST__ = $artcommon;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="media connect">
                   <div class="media-left">
                      ...
                      <?php else: ?>
                         <img class="media-object img-circle  img-50" src="<?php echo ($vo["ac_img"]); ?>" alt="<?php echo ($vo["ac_name"]); ?>"><?php endif; ?>
                   </div>
                   <div class="media-body">
                      <div class="fool">#<?php echo ($vo["ac_id"]); ?></div>
                      <p class="media-heading">
                          <a><span class="glyphicon glyphicon-user"></span></a>&nbsp;&nbsp;&nbsp;<?php echo ($vo["ac_name"]); ?>&nbsp;&nbsp;&nbsp;
                          <a><span class="glyphicon glyphicon-time"></span></a>&nbsp;<?php echo (getTime($vo["ac_time"])); ?>&nbsp;&nbsp;&nbsp;&nbsp;
                          <a class="from"><?php echo ($vo["ac_from"]); ?></a>&nbsp;&nbsp;&nbsp;&nbsp;
                          <a><span class="glyphicon glyphicon-map-marker"></span></a>&nbsp;&nbsp;<?php echo ($vo["ip"]); ?>
                      </p>
                      <div class="connect-box"> <?php echo (reFace($vo["ac_content"])); ?></div>
                      <?php if(empty($vo['ac_rtime'])): ?><hr class="content-hr" />
                         <div class="media">
                             <div class="media-left">
                      ...
                      <?php else: ?>
                         ...
                         <div class="media">
                            ...
                            <div class="media-body">
                                <p class="media-heading">
                                       <a><span class="glyphicon glyphicon-king"></span></a>&nbsp;&nbsp;&nbsp;<?php echo ($vo["ac_rname"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;
                                       <a><span class="glyphicon glyphicon-send"></span></a>&nbsp;<?php echo (date("m-d H:i",$vo["ac_rtime"])); ?>&nbsp;&nbsp;&nbsp;&nbsp;回复&nbsp;
                                       <a>@<?php echo ($vo["ac_name"]); ?></a>&nbsp;中说到：
                                </p>
            ...
            <div class="home-from">
                ...
                <div class="collapse" id="collapseExample">
					...
					<input id="jump" type="hidden"  value="/article-5.html" />
