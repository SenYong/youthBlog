    ...
    <body>  
		...
		<div class="row aerousel">
			...
			<div class="col-md-8 row-l about-all">
				<h4>关于我</h4><hr />
				<div class="about">
					<p><img class="image-light about-img thumbnail" src="/Public/Img/mys.jpg" style="width: 320px;height: 400px;" /></p>
					<p><strong>姓名</strong>：哆啦A梦</p>
					<p><strong>网名</strong>：我是哆啦A梦</p>
					...
					<p><strong>喜欢的话</strong>：人活着就是为了生存，而生存易生活难，每每很多问题困扰我的时候，我总是想着自己的网名：<a>我是哆啦A梦</a>，然后让自己开开心心的过每一天，把不开心的事都一一过滤。每一天都有计划和学习，那样的日子才是最好的，不是么？</p>					
				</div>
