...
<link rel="stylesheet" href="/Public/Css/my.css" />
	...
	<div class="row aerousel">
		...
		<div class="col-md-8 row-l">
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂无说说" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="media feel">
					<div class="f-time"><a><span class="glyphicon glyphicon-dashboard"></span></a>&nbsp;&nbsp; <?php echo (getTime($vo["s_time"])); ?>在 <a class="from"><?php echo ($vo["s_from"]); ?></a> 说到：</div>
					<div class="media-left media-middle">
					    <img class="media-object img-50" src="/Public/Img/mys.jpg" alt="...">
					</div>
					<div class="media-body feel-body"><a href="<?php echo U('/feel-'.$vo['s_id']);?>"><?php echo ($vo["s_content"]); ?></a></div>
			   </div><?php endforeach; endif; else: echo "暂无说说" ;endif; ?>
			<?php echo ($page); ?>
		</div>
