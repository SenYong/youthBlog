...
<link rel="stylesheet" href="/Public/Css/my.css" />
    ...
    <body>  
		...
		<div class="container hidden-xs ppt">
                ...
                <?php if(is_array($ppt)): $i = 0; $__LIST__ = $ppt;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="" target="_blank"><img src="<?php echo ($vo["pp_img"]); ?>" alt=""  title="" /></a><?php endforeach; endif; else: echo "" ;endif; ?>
		</div>
		<div class="row aerousel">
			...
			<?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "暂时没有文章" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><article>
					<h5>
						...
						<a href="<?php echo U('/article-'.$vo['a_id']);?>"><?php echo ($vo["a_title"]); ?></a>
						<img  class="title_r hidden-xs" src="/Public/Img/icon/tuijian.gif"/>				
					</h5>
					<div class="clearfix" >           
						<p class="article-remark"> 
							<a class="article-img-a image-light hidden-xs" href="<?php echo U('/article-'.$vo['a_id']);?>"><img src="<?php echo ($vo["a_img"]); ?>" class="article-img" alt="" title="" style="width: 260px;height: 170px;"/></a>
							<?php echo ($vo["a_remark"]); ?>
							<a href="<?php echo U('/article-'.$vo['a_id']);?>" class="article-look">继续阅读→</a>
						</p>
