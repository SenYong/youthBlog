...
<link rel="stylesheet" href="/Public/Css/my.css" />
    ...
    <div class="row aerousel">
		...
		<ul class="album-div">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="album-li">
                <div class="image-light album-img">
                  	<img src="<?php echo ($vo["al_img"]); ?>" alt="<?php echo ($v["al_name"]); ?>">
                </div>
                <div class="caption album-remark">
                    <h5><?php echo ($vo["al_name"]); ?></h5>
                    <a href="<?php echo U('/album-'.$vo['al_id']);?>" class="btn btn-primary btn-xs" role="button">查看全部</a>
                </div>
