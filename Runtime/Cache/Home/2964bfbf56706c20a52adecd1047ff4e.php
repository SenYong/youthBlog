        ...
        <div class="container ">
      	...
      	<div class="row aerousel">
			...
			<div class="col-md-8 row-l">
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂无文章" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><article>
						<h5>
						...
						<div class="post-summary">
							<div class="clearfix" >           
								<p class="article-remark"> 
									<a class="article-img-a image-light" href="<?php echo U('/article-'.$vo['a_id']);?>"><img src="<?php echo ($vo["a_img"]); ?>" class="article-img"/></a>	
									<?php echo ($vo["a_remark"]); ?>
									<a href="<?php echo U('/article-'.$vo['a_id']);?>" class="article-look">继续阅读→</a>
								</p>
								<footer class="article-footer">
									<div class="article-footer-l">
										<span class="glyphicon glyphicon-tags blog-icon"></span><?php echo (getKeyword($vo["a_keyword"])); ?>
									</div>
			        ...
			        </article><?php endforeach; endif; else: echo "暂无文章" ;endif; ?>
		    </div>	
