	...
	<div class="row aerousel">
    	...
    	<div class="col-md-8 row-l">
    		<div class="row album-look">	
        		<?php if(is_array($pictures)): $i = 0; $__LIST__ = $pictures;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-xs-6 col-md-3">
                        <a class="fancybox-buttons thumbnail preview" data-fancybox-group="button" href="<?php echo ($vo["p_img"]); ?>">
                            <img src="<?php echo ($vo["p_thumb"]); ?>" alt="<?php echo ($vo["remark"]); ?>"/>
                        </a>
                    </div><?php endforeach; endif; else: echo "" ;endif; ?>
    		</div>
            <?php if(is_array($alcommon)): $i = 0; $__LIST__ = $alcommon;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="media connect">
                   <div class="media-left">
                      <?php if(!empty($vo['alc_url'])): ?><a href="<?php echo ($vo["alc_url"]); ?>" target="_blank" rel="nofollow" title="浏览 <?php echo ($vo["alc_name"]); ?> 的网站?"><img class="media-object img-circle  img-50" src="<?php echo ($vo["alc_img"]); ?>" alt="<?php echo ($vo["alc_name"]); ?>"></a>
                      <?php else: ?>
                         <img class="media-object img-circle  img-50" src="<?php echo ($vo["alc_img"]); ?>" alt="<?php echo ($vo["alc_name"]); ?>"><?php endif; ?>
                   </div>
                   <div class="media-body">
                       <div class="fool">#<?php echo ($vo["alc_id"]); ?></div>
                       <p class="media-heading">
                         <a><span class="glyphicon glyphicon-user"></span></a>&nbsp;&nbsp;&nbsp;<?php echo ($vo["alc_name"]); ?>&nbsp;&nbsp;&nbsp;
                         <a><span class="glyphicon glyphicon-time"></span></a>&nbsp;<?php echo (getTime($vo["alc_time"])); ?>&nbsp;&nbsp;&nbsp;&nbsp;
                         <a class="from"><?php echo ($vo["alc_from"]); ?></a>&nbsp;&nbsp;&nbsp;&nbsp;
                       ...
                       <?php if(empty($vo['alc_rtime'])): ?><hr class="content-hr" />
                          <div class="media">
                              <div class="media-left">
                                 <a><img class="media-object img-circle img-50" src="<?php echo ($vo["alc_img"]); ?>" alt="<?php echo ($vo["sc_rname"]); ?>"></a>
                             </div>
                             <div class="media-body">
                                 <p>正等待博主回复</p>
                             </div>
                       ...
                       <?php else: ?>
                          ...
                          <div class="media">
                            <div class="media-left">
                                <a><img class="media-object img-circle img-50" src="/Public/Img/logo/logo.jpg" alt="<?php echo ($vo["ac_rname"]); ?>"></a>
                            </div>
                            <div class="media-body">
                                <p class="media-heading">
                                       <a><span class="glyphicon glyphicon-king"></span></a>&nbsp;&nbsp;&nbsp;<?php echo ($vo["alc_rname"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;
                                       <a><span class="glyphicon glyphicon-send"></span></a>&nbsp;<?php echo (date("m-d H:i",$vo["alc_rtime"])); ?>&nbsp;&nbsp;&nbsp;&nbsp;回复&nbsp;
                                       <a>@<?php echo ($vo["alc_name"]); ?></a>&nbsp;中说到：
                                </p>
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="well">
                            <div method="post" >
                    			...
                    			<input id="jump" type="hidden"  value="/album-11.html" />
