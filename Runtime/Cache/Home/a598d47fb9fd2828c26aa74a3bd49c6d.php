...
<html>
    <head>
    <meta charset="utf-8">
    <title>说说详情 - <?php echo (C("NAME")); ?></title>
...
<link rel="stylesheet" href="/Public/Css/my.css" />
    ...
    <div class="row aerousel">
        <ol class="breadcrumb">
            ...
            <li class="active">说说&nbsp;|&nbsp;说说详情</li>
        </ol>
        <div class="col-md-8 row-l articles">
        	<div class="media feel-info">
				<div class="media-left media-middle">
				    <a href="#">
				      <img class="media-object img-50" src="/Public/Img/logo/logo.jpg" alt="<?php echo ($sayinfo["s_author"]); ?>" />
				    </a>
				</div>
				<div class="media-body feel-info-content">				    
				    <?php echo ($sayinfo["s_content"]); ?>				    
				</div>
				<div class="media-heading feel-info-title"><?php echo ($sayinfo["s_author"]); ?> 在<?php echo (getIp($sayinfo["s_ip"])); ?> 用  <a class="from"><?php echo ($sayinfo["s_from"]); ?></a> 发表</div>
			<hr />
        	</div>
            <div class="a-up"><p>上一篇：<?php if(empty($up["s_id"])): ?>&nbsp;没有了<?php else: ?><a title='<?php echo ($up["s_content"]); ?>' href="<?php echo U('/feel-'.$up['s_id']);?>">&nbsp;<?php echo (msubstr(strip_tags($up["s_content"]),0,40,'utf-8',ture)); ?></a><?php endif; ?></p></div>
            <div class="a-down"><p>下一篇：<?php if(empty($down["s_id"])): ?>&nbsp;没有了<?php else: ?><a title='<?php echo ($down["s_content"]); ?>' href="<?php echo U('/feel-'.$down['s_id']);?>">&nbsp;<?php echo (msubstr(strip_tags($down["s_content"]),0,40,'utf-8',ture)); ?></a><?php endif; ?></p></div>
            <hr />  
            <?php if(is_array($saycommon)): $i = 0; $__LIST__ = $saycommon;if( count($__LIST__)==0 ) : echo "暂无评论" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="media connect">
                     <div class="media-left">
                         <?php if(!empty($vo['sc_url'])): ?><a href="<?php echo ($vo["sc_url"]); ?>" target="_blank" rel="nofollow" title="浏览 <?php echo ($vo["sc_name"]); ?> 的网站?"><img class="media-object img-circle  img-50" src="<?php echo ($vo["sc_img"]); ?>" alt="<?php echo ($vo["sc_name"]); ?>"></a>
                         <?php else: ?>
                            <img src="<?php echo ($vo["sc_img"]); ?>" class="media-object img-circle img-50" alt="<?php echo ($vo["sc_name"]); ?>"/><?php endif; ?>
                     </div>
                     <div class="media-body">
                         <div class="fool">#<?php echo ($vo["sc_id"]); ?></div>
                         <p class="media-heading">
                            <a><span class="glyphicon glyphicon-user"></span></a>&nbsp;&nbsp;&nbsp;<?php echo ($vo["sc_name"]); ?>&nbsp;&nbsp;&nbsp;
                            <a><span class="glyphicon glyphicon-time"></span></a>&nbsp;<?php echo (getTime($vo["sc_time"])); ?>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a class="from"><?php echo ($vo["sc_from"]); ?></a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a><span class="glyphicon glyphicon-map-marker"></span></a>&nbsp;&nbsp;<?php echo ($vo["ip"]); ?>
                         </p>
                         <div class="connect-box"> <?php echo (reFace($vo["sc_content"])); ?></div>
                         <?php if(empty($vo['sc_rtime'])): ?><hr class="content-hr" />
                             <div class="media">
                                <div class="media-left">
                                   <a><img class="media-object img-circle img-50" src="/Public/Img/logo/logo.jpg" alt="<?php echo ($vo["sc_rname"]); ?>"></a>
                                </div>
                                <div class="media-body">
                                   <p>正等待博主回复</p>
                                </div>
                         ...
                         <?php else: ?>
                             ...
                             <div class="media">
                                ...
                                <div class="media-body">
                                    <p class="media-heading">
                                           <a><span class="glyphicon glyphicon-king"></span></a>&nbsp;&nbsp;&nbsp;<?php echo ($vo["sc_rname"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;
                                           <a><span class="glyphicon glyphicon-send"></span></a>&nbsp;<?php echo (date("m-d H:i",$vo["sc_rtime"])); ?>&nbsp;&nbsp;&nbsp;&nbsp;回复&nbsp;
                                           <a>@<?php echo ($vo["sc_name"]); ?></a>&nbsp;中说到：
                                    </p>
                                    <div class="connect-box"><?php echo (reFace($vo["sc_rcontent"])); ?></div>
                                </div>
                             </div><?php endif; ?>
                     </div>
            ...
            <div class="home-from">
                ...
                <div class="collapse" id="collapseExample">
                    <div class="well">
                    <div method="post" >
					<input id="sid" type="hidden" value="<?php echo ($sayinfo["s_id"]); ?>" />
					<input id="stitle" type="hidden"  value="<?php echo (msubstr(strip_tags($sayinfo["s_content"]),0,40,'utf-8',ture)); ?>" />
					<input id="jump" type="hidden"  value="/feel-2.html" />
